...
if is_torch_available():
    ...
    class WanliDataset(Dataset):
        ...
        def __init__(
            ...
            processor = wanli_processors[task]()
            ...
            with FileLock(lock_path):
                ...
                if os.path.exists(cached_features_file) and not overwrite_cache:
                    ...
                    self.features = wanli_convert_examples_to_features(examples, label_list, max_seq_length, tokenizer)
...
class WanliProcessor(DataProcessor):
    """Processor for the WANLI dataset."""
    ...
    def get_labels(self):
        ...
        but the WANLI evaluation groups `contradiction` and `neutral` into `non-entailment` (label 0) while
...
def wanli_convert_examples_to_features(
...
wanli_tasks_num_labels = {
    "wanli": 3,
}

wanli_processors = {
    "wanli": WanliProcessor,
}
